...
class ARCLViewController: UIViewController, CLLocationManagerDelegate {
    ...
    var pois: [POIModel]!
    var locationAnnotationNode2POI: [LocationTextAnnotationNode: POIModel]!
    ...
    func setupPOIs() {
        pois = []
        locationAnnotationNode2POI = [LocationTextAnnotationNode: POIModel]()
        drawnLocationNodes = []
    }
    ...
    // MARK: AR Scene
    func addPOIToARScene(_ poi: POIModel) {
        // create node
    ...
    func addFinalRouteSegmentToARScene(_ routeSegment: RouteSegment) {
        ...
        let routeSegmentAnnotationNode = RouteSegmentAnnotation(startNode: startNode, endNode: endNode)
    ...
    func addDestinationPOIToARScene(_ poi: POIModel) {
    ...
    func presentPOIAlertViewfor(poi: POIModel) {
